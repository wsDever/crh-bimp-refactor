...
} }); }); }, Object.defineProperty(e.prototype, "previewStyles", { get: function () { return { width: this.previewSize / 75 + "rem", height: this.previewSize / 75 + "rem", borderRadius: 7 / 75 + "rem" }; }, enumerable: !0, configurable: !0 }), e.prototype.render = function () { var e = this; return [nb_component_core_js_1.h("div", { class: "upload-images " + this.styleId }, this.previewImages.map(function (t) { return nb_component_core_js_1.h("div", { class: "preview", style: Object.assign({}, e.previewStyles, { background: "url(" + (t.url || t.base64) + ") no-repeat center / cover" }) }, nb_component_core_js_1.h("i", { innerHTML: ICONS.qingchu, onClick: e.removeImage.bind(e, t) })); }), this.previewImages.length < this.maxLength && nb_component_core_js_1.h("div", { class: "up-btn", style: Object.assign({}, this.previewStyles), onClick: this.selectImage.bind(this) }, this.loading && nb_component_core_js_1.h("div", { class: "lds-ring" }, nb_component_core_js_1.h("div", null), nb_component_core_js_1.h("div", null), nb_component_core_js_1.h("div", null), nb_component_core_js_1.h("div", null)), !this.loading && nb_component_core_js_1.h("div", { class: "cross-x" }), !this.loading && nb_component_core_js_1.h("div", { class: "cross-y" }), !this.loading && nb_component_core_js_1.h("span", { class: "text" }, this.uploadText))), nb_component_core_js_1.h("input", { onChange: this.upload.bind(this), ref: function (t) { return e.uploader = t; }, style: { display: "none" }, type: "file", accept: "image/jpeg, image/jpg, image/png, image/bmp, image/gif", multiple: !0 })]; }, Object.defineProperty(e, "is", { get: function () { return "nb-upload-simple-image"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "encapsulation", { get: function () { return "shadow"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "properties", { get: function () { return { getImages: { method: !0 }, imageSize: { type: Number, attr: "image-size" }, loading: { state: !0 }, maxLength: { type: Number, attr: "max-length" }, previewImages: { state: !0 }, previewSize: { type: Number, attr: "preview-size" }, rate: { type: Number, attr: "rate" }, styleId: { type: String, attr: "style-id" }, uploadText: { type: String, attr: "upload-text" } }; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "events", { get: function () { return [{ name: "error", method: "error", bubbles: !0, cancelable: !0, composed: !0 }, { name: "change", method: "change", bubbles: !0, cancelable: !0, composed: !0 }]; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "style", { get: function () { return ".upload-images{padding:.4rem 0 0 .4rem}.upload-images .preview,.upload-images .up-btn{display:inline-block;margin-right:.26666666666666666rem;margin-bottom:.26666666666666666rem;position:relative}.upload-images .preview i,.upload-images .up-btn i{width:.48rem;height:.48rem;position:absolute;right:-.24rem;top:-.24rem;color:#666}.upload-images .up-btn{display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;position:relative;border:1px dashed #ccc;cursor:pointer;vertical-align:top}.upload-images .up-btn .cross-x,.upload-images .up-btn .cross-y{position:absolute;width:.8rem;height:3px;margin-top:-.26666666666666666rem;border-radius:3px;background:#666}.upload-images .up-btn .cross-y{width:3px;height:.8rem}.upload-images .up-btn .text{position:absolute;bottom:15%;color:#666;font-size:.37333333333333335rem}.upload-images .icon{fill:currentColor;overflow:hidden;vertical-align:-.15em;display:inline-block}.upload-images.c999 .up-btn{background:#fbfbfb}.upload-images.c999 .up-btn .text{color:#999}.upload-images.c999 .up-btn .cross-x,.upload-images.c999 .up-btn .cross-y{background:#999}.upload-images .lds-ring{display:inline-block;position:relative;width:.8533333333333334rem;height:.8533333333333334rem}.upload-images .lds-ring div{-webkit-box-sizing:border-box;box-sizing:border-box;display:block;position:absolute;width:.68rem;height:.68rem;margin:.08rem;border:3px solid #ccc;border-radius:50%;-webkit-animation:lds-ring 1.2s cubic-bezier(.5,0,.5,1) infinite;animation:lds-ring 1.2s cubic-bezier(.5,0,.5,1) infinite;border-color:#ccc transparent transparent transparent}.upload-images .lds-ring div:first-child{-webkit-animation-delay:-.45s;animation-delay:-.45s}.upload-images .lds-ring div:nth-child(2){-webkit-animation-delay:-.3s;animation-delay:-.3s}.upload-images .lds-ring div:nth-child(3){-webkit-animation-delay:-.15s;animation-delay:-.15s}\@-webkit-keyframes lds-ring{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}\@keyframes lds-ring{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}"; }, enumerable: !0, configurable: !0 }), e; }();
