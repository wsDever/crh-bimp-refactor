...
var DatetimePicker = function () { function e() { this.format = "YYYY-MM-DD HH:mm", this.date = null, this.for = null, this.rows = 7, this.textTitle = "选择日期时间", this.textConfirm = "确定", this.textCancel = "取消"; } return e.prototype.getPicker = function () { return tslib_1.__awaiter(this, void 0, void 0, function () { return tslib_1.__generator(this, function (e) { return [2, this.Picker]; }); }); }, e.prototype.componentDidLoad = function () { var e = document.querySelector(this.for), t = this.el.shadowRoot.querySelector(".picker-container"); this.Picker = new Picker(e, { container: t, rows: this.rows, format: this.format, date: this.date, headers: !1, language: "zh-CN", text: { title: this.textTitle, confirm: this.textConfirm, cancel: this.textCancel }, translate: function (e, t) { return Number(t) + { year: "年", month: "月", day: "日", hour: "时", minute: "分" }[e]; } }), this.ready.emit({ picker: this.Picker }); }, e.prototype.render = function () { return nb_component_core_js_1.h("div", { class: "datetime-picker" }, nb_component_core_js_1.h("slot", null), nb_component_core_js_1.h("div", { class: "picker-container" })); }, Object.defineProperty(e, "is", { get: function () { return "nb-datetime-picker"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "encapsulation", { get: function () { return "shadow"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "properties", { get: function () { return { date: { type: "Any", attr: "date" }, el: { elementRef: !0 }, for: { type: String, attr: "for" }, format: { type: String, attr: "format" }, getPicker: { method: !0 }, rows: { type: Number, attr: "rows" }, textCancel: { type: String, attr: "text-cancel" }, textConfirm: { type: String, attr: "text-confirm" }, textTitle: { type: String, attr: "text-title" } }; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "events", { get: function () { return [{ name: "ready", method: "ready", bubbles: !0, cancelable: !0, composed: !0 }]; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "style", { get: function () { return ".picker.sc-nb-datetime-picker{background-color:rgba(0,0,0,.2);color:#333;direction:ltr;display:none;line-height:1.5;overflow:hidden;-ms-touch-action:none;touch-action:none;-webkit-transition:opacity .15s;transition:opacity .15s;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.picker-fixed.sc-nb-datetime-picker{bottom:0;left:0;position:fixed;right:0;top:0;z-index:1986}.picker-fixed.sc-nb-datetime-picker > .picker-dialog.sc-nb-datetime-picker{bottom:-100%;left:0;max-height:100%;position:absolute;right:0;-webkit-transition:bottom .3s;transition:bottom .3s}.picker-fixed.sc-nb-datetime-picker   .picker-header.sc-nb-datetime-picker{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between}.picker-fixed.sc-nb-datetime-picker   .picker-footer.sc-nb-datetime-picker{display:table}.picker-open.sc-nb-datetime-picker{display:block;opacity:0}.picker-opened.sc-nb-datetime-picker{opacity:1}.picker-opened.sc-nb-datetime-picker > .picker-dialog.sc-nb-datetime-picker{bottom:0}.picker-dialog.sc-nb-datetime-picker{background-color:#fff;border:1px solid #eee}.picker-header.sc-nb-datetime-picker{border-bottom:1px solid #eee;display:none;height:1.066666666666667rem;position:relative}.picker-title.sc-nb-datetime-picker{font-size:.4266666666666667rem;font-weight:500;color:#272727;margin:0}.picker-close.sc-nb-datetime-picker:focus, .picker-close.sc-nb-datetime-picker:hover{opacity:1;outline:none}.picker-body.sc-nb-datetime-picker{overflow:hidden;position:relative}.picker-body.sc-nb-datetime-picker   .picker-picked-line.sc-nb-datetime-picker{position:absolute;height:.9333333333333333rem;width:100%;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);border:1px solid #eee;pointer-events:none}.picker-grid.sc-nb-datetime-picker{display:table;table-layout:fixed;width:100%}.picker-cell.sc-nb-datetime-picker{display:table-cell;position:relative}.picker-cell.sc-nb-datetime-picker:after, .picker-cell.sc-nb-datetime-picker:before{content:\"\";display:block;left:0;position:absolute;right:0;z-index:3}.picker-headers.sc-nb-datetime-picker   .picker-cell.sc-nb-datetime-picker:before{margin-bottom:0}.picker-headers.sc-nb-datetime-picker   .picker-cell.sc-nb-datetime-picker:after{margin-top:32px}.picker-cell__header.sc-nb-datetime-picker, .picker-single.sc-nb-datetime-picker:not(.picker-controls):not(.picker-headers)   .picker-cell.sc-nb-datetime-picker:after, .picker-single.sc-nb-datetime-picker:not(.picker-controls):not(.picker-headers)   .picker-cell.sc-nb-datetime-picker:before{display:none}.picker-cell__control.sc-nb-datetime-picker{cursor:pointer;height:32px;padding:4px 8px;position:relative;z-index:4}.picker-cell__control.sc-nb-datetime-picker:before{border:0 solid #ccc;content:\"\";display:block;height:8px;left:50%;position:absolute;top:50%;-webkit-transform:translate(-50%,-50%) rotate(-45deg);transform:translate(-50%,-50%) rotate(-45deg);width:8px}.picker-cell__control.sc-nb-datetime-picker:hover:before{border-color:#ccc}.picker-cell__control--prev.sc-nb-datetime-picker:before{border-right-width:1px;border-top-width:1px;margin-top:2px}.picker-cell__control--next.sc-nb-datetime-picker:before{border-bottom-width:1px;border-left-width:1px;margin-bottom:2px}.picker-cell__body.sc-nb-datetime-picker{overflow:hidden;position:relative}.picker-cell__body.sc-nb-datetime-picker:after, .picker-cell__body.sc-nb-datetime-picker:before{content:\"\";height:1.866666666666667rem;left:0;position:absolute;right:0;z-index:1}.picker-cell__body.sc-nb-datetime-picker:before{background-image:-webkit-linear-gradient(bottom,hsla(0,0%,100%,0),#fff);background-image:-webkit-gradient(linear,left bottom,left top,from(hsla(0,0%,100%,0)),to(#fff));background-image:linear-gradient(0deg,hsla(0,0%,100%,0),#fff);top:0}.picker-cell__body.sc-nb-datetime-picker:after{background-image:-webkit-linear-gradient(top,hsla(0,0%,100%,0),#fff);background-image:-webkit-gradient(linear,left top,left bottom,from(hsla(0,0%,100%,0)),to(#fff));background-image:linear-gradient(180deg,hsla(0,0%,100%,0),#fff);bottom:0}.picker-single.sc-nb-datetime-picker   .picker-cell__body.sc-nb-datetime-picker:after, .picker-single.sc-nb-datetime-picker   .picker-cell__body.sc-nb-datetime-picker:before{display:none}.picker-list.sc-nb-datetime-picker{list-style:none;margin:-32px 0;padding:0;position:relative}.picker-item.sc-nb-datetime-picker{color:#999;height:.9333333333333333rem;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;width:100%;white-space:nowrap;font-size:.4266666666666667rem}.picker-picked.sc-nb-datetime-picker{color:#272727;font-size:.5066666666666667rem}.picker-cancel.sc-nb-datetime-picker, .picker-confirm.sc-nb-datetime-picker{background-color:transparent;border-width:0;cursor:pointer;display:table-cell;font-size:.37333333333333335rem;width:1.6rem;color:#3e86f7}.picker-cancel.sc-nb-datetime-picker:focus, .picker-cancel.sc-nb-datetime-picker:hover, .picker-confirm.sc-nb-datetime-picker:focus, .picker-confirm.sc-nb-datetime-picker:hover{background-color:#fcfcfc;outline:none}"; }, enumerable: !0, configurable: !0 }), e; }();
