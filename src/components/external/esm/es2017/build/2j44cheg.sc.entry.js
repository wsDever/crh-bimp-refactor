...
class Switch {
    ...
    static get style() { return ".switch.sc-nb-switch{position:relative;display:inline-block;vertical-align:middle}.switch.disabled.sc-nb-switch{opacity:.8}.switch.sc-nb-switch   .roundball.sc-nb-switch{background:#fff;border:1px solid #f5f5f5;border-radius:50%;position:absolute;left:.02666666666666667rem;top:.02666666666666667rem;-webkit-transition:-webkit-transform .3s;transition:-webkit-transform .3s;transition:transform .3s;transition:transform .3s,-webkit-transform .3s}"; }
}
